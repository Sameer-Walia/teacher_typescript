...
function AdminHome()
{
    ...
    function oncontact(e: React.MouseEvent<HTMLAnchorElement, MouseEvent>)
    {
        e.preventDefault()
        if (isLoggedIn === false)
        {
    ...
    function admin(e: React.MouseEvent<HTMLAnchorElement, MouseEvent>)
    {
        e.preventDefault()
        if (isLoggedIn === false)
        {
            ...
            <div className="custom-background">
                <div className="custom-text-center">
                    ...
                    <div className="custom-buttons">
                        ...
                        <Link to="" onClick={oncontact} className="custom-button-contact" >Contact Us</Link>
                        <Link to=""
                            onClick={(e) =>
                            {
                                handleTabClick("user");
